...
RUN if [ "$INSTALL_DESKTOP" = "true" ]; then \
        ...
        && sed -i 's|</body>|<script type="module">import UI from "./app/ui.js";window.UI=UI;</script><script src="custom-clipboard-image.js?v=20260909a"></script></body>|' /opt/noVNC/vnc.html \
